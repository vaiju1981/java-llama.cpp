...
[![llama.cpp b9930](https://img.shields.io/badge/llama.cpp-%23b9930-informational)](https://github.com/ggml-org/llama.cpp/releases/tag/b9930)  
...
**Runnable example app.** A minimal, KISS on-device chat demo — pick a GGUF from the file
system, then chat with it, tokens streaming into a Jetpack Compose UI — lives in
[`llama-android-example/`](llama-android-example/README.md). It builds with plain
Gradle/AGP (no Android Studio required), produces a Play-shaped signed `.aab`, and is
validated in CI by a real on-device emulator UI test. See its README for the build,
signing/Play, and testing walkthrough.

...
Current llama.cpp pinned version: **b10969**
...
git clone --depth 1 --branch b10969 https://github.com/ggml-org/llama.cpp /tmp/lc
...
Because `sccache` is **content-addressed** and llama.cpp is pinned (`GIT_TAG b10969`), the
...
llama.cpp is fetched via CMake FetchContent, pinned to `GIT_TAG b10969`.

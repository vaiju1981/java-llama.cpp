...
Current llama.cpp pinned version: **b10980**
...
git clone --depth 1 --branch b10980 https://github.com/ggml-org/llama.cpp /tmp/lc
...
Because `sccache` is **content-addressed** and llama.cpp is pinned (`GIT_TAG b10980`), the
...
llama.cpp is fetched via CMake FetchContent, pinned to `GIT_TAG b10980`.
